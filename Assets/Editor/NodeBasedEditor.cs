...
public class NodeBasedEditor : EditorWindow {
    ...
    {
        NodeBasedEditor windows = GetWindow<NodeBasedEditor>();
        windows.titleContent = new GUIContent("Node Based Editor");
    }
    ...
    private void OnClickAddNode(Vector2 mousePosition)
    {
        ...
        nodes.Add(new Node(mousePosition, 200, 50, nodeStyle, selectedNodeStyle, inPointStyle,
